...
class Document extends Model {
	 ...
	 */
	protected $fillable = [
		'reference', 'account_id', 'terminal_id', 'transact_by', 'date', 'type', 'status', 'discount', 'discount_amount', 'service_charge', 'tax_amount', 'rounding', 'charge', 'refund', 'received', 'change', 'note', 'properties',
	];
