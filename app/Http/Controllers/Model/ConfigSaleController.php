...
class ConfigSaleController extends Controller
{
    ...
    public function create(Request $request){ 
        ...
        $data = new ConfigSale($request->all());
    ...
    public function all(Request $request){
      ...
      $model = \App\Models\ConfigSale::orderBy($option['by'], $option['order']);
  ...
  public function destroy(Request $request){
       ...
       if ($request->has('password')) {
          if (UC::isCurrentUser($request->input('password'))) {
             $affectedRows = ConfigSale::onlyTrashed()->forceDelete();
             if($affectedRows){
