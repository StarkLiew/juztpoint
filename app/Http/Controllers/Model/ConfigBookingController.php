...
class ConfigBookingController extends Controller
{
    ...
    public function create(Request $request){ 
        ...
        $data = new ConfigBooking($request->all());
    ...
    public function all(Request $request){
      ...
      $model = \App\Models\ConfigBooking::orderBy($option['by'], $option['order']);
  ...
  public function destroy(Request $request){
       ...
       if ($request->has('password')) {
          if (UC::isCurrentUser($request->input('password'))) {
             $affectedRows = ConfigBooking::onlyTrashed()->forceDelete();
             if($affectedRows){
