...
use App\Models\ConfigStaffNotification;
...
class ConfigStaffNotificationController extends Controller
{
  ...
  public function create(Request $request){ 
        ...
        $data = new ConfigStaffNotification($request->all());
    ...
    public function all(Request $request){
      ...
      $model = \App\Models\ConfigStaffNotification::orderBy($option['by'], $option['order']);
   ...
   public function detail(Request $request){
          ...
          $result = ConfigStaffNotification::first();
    ...
    public function update($id, Request $request){
        ...
        $data = ConfigStaffNotification::first();
    ...
    public function trash($id, Request $request){
      ...
      if(!empty($id)){
         $data = ConfigStaffNotification::find($id);
          if ($data !== null) {
  ...
  public function destroy(Request $request){
       ...
       if ($request->has('password')) {
          if (UC::isCurrentUser($request->input('password'))) {
             $affectedRows = ConfigStaffNotification::onlyTrashed()->forceDelete();
             if($affectedRows){
