<template>
    <v-row class="fill-height">
        <v-col>
            ...
            <v-sheet height="70vh">
                <v-calendar ref="calendar" v-model="focus" color="primary" :events="events" :event-color="getEventColor" :event-margin-bottom="3" :now="today" :type="'4day'" :first-interval="24" :interval-minutes="30" :interval-count="20" :interval-height="40" @click:event="showEvent" @click:more="viewDay" @click:date="viewDay" @change="updateRange">
                </v-calendar>
